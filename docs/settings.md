...
| `providers.imageAntigravityModel`   | string  | _(unset)_ | Model ID for Google Antigravity image generation; defaults to `gemini-3.1-flash-image`, overridden by `PI_ANTIGRAVITY_IMAGE_MODEL` or `ANTIGRAVITY_IMAGE_MODEL`.                                                                                                                                                                                                                                                                                                                                                                       |
