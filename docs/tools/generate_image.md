...
6. Provider dispatch:
   ...
   - Antigravity: Google Antigravity SSE endpoint (default model `gemini-3.1-flash-image`, configurable via `providers.imageAntigravityModel` or `PI_ANTIGRAVITY_IMAGE_MODEL`).
